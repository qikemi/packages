...
/**
 * 
 * Create Date: 2014年8月20日 下午10:20:22 Author XieXianbin<a.b@hotmail.com> Source
...
public class Dateutil {
	...
	/**
	 * 创建指定格式的日期 例：2014-08-19 09:23:01
	 * 
	 * @param dateFormat
	 * @return
	 */
	public static String getDateTime() {
		Date date = new Date();
		SimpleDateFormat sdf = new SimpleDateFormat(Dateutil.YYYY_MM_DD__HHMMss);
		return sdf.format(date);
	}

	/**
	 * 创建指定格式的日期 默认：2014-08-19 21:23:01
	 * 
	 * @param dateFormat
	 * @return
	 */
	...
	public static Date format2Date(String dateStr, String dateFromat) {
		...
		try {
			...
			logger.warn("--> when Format dateStr: " + dateStr
					+ ", to dateFormat: " + dateFromat
					+ ". Occur an Exception: " + e.toString());
			return null;
		}
		return date;
	}
	...
	/**
	 * 将秒转化为时间 2014-08-19 21:23:01
	 * 
	 * @return
	 */
	public static String convertSeconds2DateTime(Long currentSeconds) {
		Date date = new Date(currentSeconds * 1000);
		return new SimpleDateFormat(Dateutil.YYYY_MM_DD__HHMMss).format(date);
	}

	/**
	 * 将豪秒转化为时间 2014-08-19 21:23:01
	 * 
	 * @return
	 */
	public static String convertCurrentMillisecond2DateTime(Long currentMillisecond) {
